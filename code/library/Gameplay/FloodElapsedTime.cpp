...
#else
        // For simplicity, 12 minutes is set for a day (1 minute of game time per 2 hours of real time) for non-fast debug builds.
        constexpr float GAMEPLAY_MINUTES_PER_REAL_DAY = 12.0f;
#endif
