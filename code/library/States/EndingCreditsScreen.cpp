...
namespace STATES
{
    ...
    GameState EndingCreditsScreen::Update(const HARDWARE::GamingHardware& gaming_hardware)
    {
        ...
        else
        {
            ...
            gaming_hardware.Speakers->PlayMusicIfNotAlready(RESOURCES::AssetId::FINAL_CREDITS_MUSIC);

            // INDICATE THE GAME SHOULD REMAIN ON THE CREDITS SCREEN.
            return GameState::ENDING_CREDITS_SCREEN;
        }
    }
    ...
    sf::Sprite EndingCreditsScreen::Render(GRAPHICS::Renderer& renderer) const
    {
