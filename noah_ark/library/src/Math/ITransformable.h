...
namespace MATH
{
    /// An interface for objects or components that
    ...
    {
    public:
        /// Virtual destructor to allow proper destruction of implementing classes.
        virtual ~ITransformable() {};

        /// Sets the position component of the transformable.
