...
namespace OVERWORLD_MAP_SPECIFICATION_TESTS
{
    ...
    TEST_CASE( "Load specification from file.  Success.", "[OverworldMapSpecification][LoadFromFile]" )
    {
        ...
        row_0_tile_maps.push_back("res/maps/testing/test_map_0_0.json");
        row_0_tile_maps.push_back("res/maps/testing/test_map_1_0.json");
        row_0_tile_maps.push_back("res/maps/testing/test_map_2_0.json");
        expected_tile_map_filepaths.push_back(row_0_tile_maps);
        // Row 1.
        std::vector<std::string> row_1_tile_maps;
        row_1_tile_maps.push_back("res/maps/testing/test_map_0_1.json");
        row_1_tile_maps.push_back("res/maps/testing/test_map_1_1.json");
        row_1_tile_maps.push_back("res/maps/testing/test_map_2_1.json");
        expected_tile_map_filepaths.push_back(row_1_tile_maps);
        // Row 2.
        std::vector<std::string> row_2_tile_maps;
        row_2_tile_maps.push_back("res/maps/testing/test_map_0_2.json");
        row_2_tile_maps.push_back("res/maps/testing/test_map_1_2.json");
        row_2_tile_maps.push_back("res/maps/testing/test_map_2_2.json");
    ...
    TEST_CASE( "Load map with single row.  Success.", "[OverworldMapSpecification][LoadFromFile]" )
    {
        ...
        // EXECUTE.
        // Load from a known specification file.
        const std::string TEST_OVERWORLD_SPECIFICATION_FILEPATH = "res/maps/testing/test_overworld_map_one_row.json";
        bool specificationLoadedSuccessfully = overworldSpecification.LoadFromFile(TEST_OVERWORLD_SPECIFICATION_FILEPATH);
    ...
    TEST_CASE( "Load map with single column.  Success.", "[OverworldMapSpecification][LoadFromFile]" )
    {
        ...
        // EXECUTE.
        // Load from a known specification file.
        const std::string TEST_OVERWORLD_SPECIFICATION_FILEPATH = "res/maps/testing/test_overworld_map_one_column.json";
        bool specificationLoadedSuccessfully = overworldSpecification.LoadFromFile(TEST_OVERWORLD_SPECIFICATION_FILEPATH);
    ...
    TEST_CASE( "Load map with single row and column.  Success.", "[OverworldMapSpecification][LoadFromFile]" )
    {
        ...
        // EXECUTE.
        // Load from a known specification file.
        const std::string TEST_OVERWORLD_SPECIFICATION_FILEPATH = "res/maps/testing/test_overworld_map_one_map.json";
        bool specificationLoadedSuccessfully = overworldSpecification.LoadFromFile(TEST_OVERWORLD_SPECIFICATION_FILEPATH);
